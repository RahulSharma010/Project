...
<script>
    ...
    function bookBus(busId) {
        ...
        link.href = `index3.php?busId=${encodeURIComponent(busId)}&busname=${encodeURIComponent(busname)}&pickup=${encodeURIComponent(pickup)}&journey=${encodeURIComponent(journey)}&drop=${encodeURIComponent(drop)}&price=${encodeURIComponent(price)}&from=${encodeURIComponent(from)}&to=${encodeURIComponent(to)}`;
    }
</script>
